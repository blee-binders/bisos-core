...
**  This File :: *= /bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/platformUpdates/pyEnvUpdate/fullUsagePanel-en.org =*
...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/platformUpdates/distroUpdate/_nodeBase_")][ =distroUpdate= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/platformUpdates/pyEnvUpdate")][pyEnvUpdate]] *|*
*   /Ancestors/  :: [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/platformUpdates/_nodeBase_")][ =platformUpdates= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/_nodeBase_")][ =platform= ]] *|*
...
####+END:
####+BEGIN: blee:panel:icm:bash:cmnd :outLevel 1 :sep nil :folding? nil :label "PipUpgrade" :icmName "bisosUpdateInterim.sh -h -v -n showRun -i pipUnDevAndUpgrades" :comment " deactivte development environment" :afterComment ""
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /PipUpgrade/ :: [[elisp:(lsip-local-run-command "bisosUpdateInterim.sh -h -v -n showRun -i pipUnDevAndUpgrades")][bisosUpdateInterim.sh -h -v -n showRun -i pipUnDevAndUpgrades]] *|*  = deactivte development environment= *|*    [[elisp:(org-shifttab)][<)]] E|
####+END:
####+BEGIN: blee:panel:icm:bash:cmnd :outLevel 1 :sep nil :folding? nil :label "UnDev" :icmName "bisosUpdateInterim.sh -h -v -n showRun -i missingPipInstall" :comment " deactivte development environment" :afterComment ""
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /UnDev/ :: [[elisp:(lsip-local-run-command "bisosUpdateInterim.sh -h -v -n showRun -i missingPipInstall")][bisosUpdateInterim.sh -h -v -n showRun -i missingPipInstall]] *|*  = deactivte development environment= *|*    [[elisp:(org-shifttab)][<)]] E|
####+END:
