...
#+roam_tags: branch
#+roam_key: blee-binders/bisos-core/platform
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/system-container/_nodeBase_/")][@ ~This System As A Container~ @]]   ::  [[elisp:(org-cycle)][| /system-container/ |]]  [[elisp:(org-shifttab)][<)]] E|
####+END
