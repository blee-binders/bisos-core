...
** 
** 
####+BEGIN: blee:panel:file:text/intro :outLevel 2 :sep t :folding t :fileName "/etc/gitlab/gitlab.rb" :comment "Title Comment"  :afterComment "Extra Info"
** /[[elisp:(beginning-of-buffer)][|^]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(delete-other-windows)][|1]]/
** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /nil/ :: [[elisp:(find-file "/etc/gitlab/gitlab.rb")][/etc/gitlab/gitlab.rb]] || [[elisp:(find-file-other-window "/etc/gitlab/gitlab.rb")][Visit In Other]] *|*  =Title Comment= *|*  Extra Info [[elisp:(org-shifttab)][<)]] E|
####+END:
** 
