...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/platform/platformUpdates/_nodeBase_")][@ ~Platform Updates~ @]]   ::  [[elisp:(org-cycle)][| /platformUpdates/ |]]  [[elisp:(org-shifttab)][<)]] E|
####+END
