...
#+title: sysChar/sysChar-Provision
#+roam_tags: branch
#+roam_key: bisos-core/sysChar/sysChar-Provision
...
**  This File :: *= /bisos/panels/bisos-core/sysChar/sysChar-Provision/_nodeBase_/fullUsagePanel-en.org =*
* /file-truename:/  /bisos/git/auth/bxRepos/blee-binders/bisos-core/sysChar/sysChar-Provision/_nodeBase_/fullUsagePanel-en.org
...
* [[elisp:(show-all)][(>]] ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
*   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseTop-50.png][http://www.freeprotocols.org]]_ _   ~Node:: bisos-core/sysChar -- sysChar-Provision~   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseBottom-50.png][http://www.by-star.net]]
...
** The abstraction is called System-Character and not Container-Character (or Platform Character) becuase
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /user/ :: [[elisp:(lsip-local-run-command "sysCharUnsitedDeploy.sh -i examples")][sysCharUnsitedDeploy.sh]]  [[elisp:(lsip-local-run-command "sysCharUnsitedDeploy.sh -i visit")][visit]]  [[elisp:(lsip-local-run-command "which -a sysCharUnsitedDeploy.sh")][which -a]]  [[elisp:(lsip-local-run-command "sysCharUnsitedDeploy.sh -i describe")][describe]] *|*  == *|*  <<sysCharUnsitedDeploy.sh>> [[sysCharUnsitedDeploy]] [[elisp:(org-shifttab)][<)]] E|
####+END:
...
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 1>> | UnsitedBisos/raw-bisos | [[FreshDebian→UnsitedBisos]] | Debian SW + BISOS + Blee                    |
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 2>> | SitedContainer         | [[Sited-Container]]          | SiteBpo is activated on Container           |
|             |                        |                          | Development BPO can be materialized         |
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 3>> | ReifiedContainer       | [[ReifiedContainer]]         | Reified -- Reg+Realized or Activated        |
|             |                        |                          | containerChar Bpo is reified                |
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 4>> | ComposedContainer      | [[ComposedContainer]]        | cntnrChar is further configured             |
|             |                        |                          | svcBpos are reified.                        |
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 5>> | MaterializedContainer  | [[MaterializedContainer]]    | Host: vag boxes, and generic guests created |
|             |                        |                          | Pure: sys/bin/extensions                    |
|             |                        |                          | Guest: Vag file created, img created.       |
|-------------+------------------------+--------------------------+---------------------------------------------|
| <<Layer 6>> | StationedContainer     | [[StationedContainer]]       | Host: Sealed                                |
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /shIcm/ :: [[elisp:(lsip-local-run-command "sysCharBoxMaterialize.sh -i examples")][sysCharBoxMaterialize.sh]]  [[elisp:(lsip-local-run-command "sysCharBoxMaterialize.sh -i visit")][visit]]  [[elisp:(lsip-local-run-command "which -a sysCharBoxMaterialize.sh")][which -a]]  [[elisp:(lsip-local-run-command "sysCharBoxMaterialize.sh -i describe")][describe]] *|*  =Builds on sysCharDeploy.sh= *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /shIcm/ :: [[elisp:(lsip-local-run-command "sysCharDeploy.sh -i examples")][sysCharDeploy.sh]]  [[elisp:(lsip-local-run-command "sysCharDeploy.sh -i visit")][visit]]  [[elisp:(lsip-local-run-command "which -a sysCharDeploy.sh")][which -a]]  [[elisp:(lsip-local-run-command "sysCharDeploy.sh -i describe")][describe]] *|*  =Commands for On Manager and On Target= *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /shIcm/ :: [[elisp:(lsip-local-run-command "sysCharDevel.sh -i examples")][sysCharDevel.sh]]  [[elisp:(lsip-local-run-command "sysCharDevel.sh -i visit")][visit]]  [[elisp:(lsip-local-run-command "which -a sysCharDevel.sh")][which -a]]  [[elisp:(lsip-local-run-command "sysCharDevel.sh -i describe")][describe]] *|*  =Switch to development mode= *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
####+END
** +
** 1) ~On Manager:~ sysCharBoxDeploy.sh  l2_sitedDevContainer #
*** +
*** sysCharBoxDeploy.sh -h -v -n showRun -p targetName="192.168.0.xx" -i l2_sitedDevContainer # OnManage
*** TODO <2024-07-17 Wed 21:44> Will because of initial addition of git hub prompt as below:
...
*** Interim Solution: Run the above command and respond to prompt
*** Re-Run: sysCharBoxDeploy.sh -h -v -n showRun -p targetName="192.168.0.xx" -i l2_sitedDevContainer
*** Then Re-Run: bx-gitReposBases -v 20 --baseDir=/bisos/git/auth --pbdName=bxReposCollection --vcMode=auth --gitLabel=mb1_github -i pbdUpdate all
*** And Re-Run: bx-gitReposBases -v 20 --baseDir="/bisos/git/auth/bxRepos" --pbdName="bxReposRoot" --vcMode="auth" --gitLabel="mb1_githu"  -i pbdUpdate all
*** Now you can run blee and move to layer-3.
*** In /bisos/venv/py3/dev-bisos3/lib/python3.11/site-packages
ln -s /bisos/git/auth/bxRepos/bisos-pip/namespace/py3/bisos
*** pip install black pygit2
*** May seem to fail svcInvSiteRegBox.cs  -i thisBox_assign  -- But is assigned verify with svcInvSiteRegBox.cs  -i thisBox_findNu
*** -
...
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *New VM:* |]]  Developer and Production  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** 1) ~On Host:~
** 2) ~On Host:~
...
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Existing VM:* |]]  Developer and Production  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** 1) ~On Host:~
** 2) ~On Host:~
...
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_     [[elisp:(outline-show-subtree+toggle)][| _*L1* FreshDebian  to Unsited Bisos_: |]] Dyslipidemia<<FreshDebian→UnsitedBisos>>   /::Layer 1::/    [[elisp:(org-shifttab)][<)]] E|
####+END
