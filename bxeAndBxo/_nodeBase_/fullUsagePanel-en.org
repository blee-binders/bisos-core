...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/sync/_nodeBase_")][@ ~Synchroniztion~ @]]   ::  [[elisp:(org-cycle)][| /Synchroniztion Of Github and BxO Repos/ |]]  [[elisp:(org-shifttab)][<)]] E|
####+END
