...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "System, Platform, BxoHolder" :anchor "Systems Terminology" :extraInfo "BSOs vs BPOs (Static vs Portable)"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *System, Platform, BxoHolder:* |]] <<Systems Terminology>> BSOs vs BPOs (Static vs Portable)  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
