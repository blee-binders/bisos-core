...
** CSMU <<Pkg-Direct>> ::  CmndSvs: Packaged+Direct+Seeded+Uploadable

** CSMU <<Single-Direct>> :: CmndSvc: Standalone+Direct  (Not Seeded, Not Uploadable)

** CSMU <<Pkg-RO>>  ::  CmndSvc: Packaged+RO
