...
*** +
*** CSMU  -- main for CS Multi-Units -- Could be Packaged or Standalone. Could be Direct, RO, or Planted
...
| Type    | Type          |         | Tag      |         |             |                              |
|---------+---------------+---------+----------+---------+-------------+------------------------------|
| CSMU    |               |         |          |         | xx.cs       | CS Multi-Units with main     |
| XU      |               |         |          |         | xx.cs       | XU (eXecution Unit) aka CSMU |
|---------+---------------+---------+----------+---------+-------------+------------------------------|
...
** XU (CSMU) <<Pkg-Direct>> ::  CmndSvs: Packaged+Direct+Seeded+Uploadable

** XU (CSMU) <<Single-Direct>> :: CmndSvc: Standalone+Direct  (Not Seeded, Not Uploadable)

** XU (CSMU) <<Pkg-RO>>  ::  CmndSvc: Packaged+RO
