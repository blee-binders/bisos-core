...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/PyCsFwrk/pypiProc/_nodeBase_")][ =pypiProc= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/PyCsFwrk/pythonDev/_nodeBase_")][ =pythonDev= ]] *|*
...
** panel ---
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "ICM To CS Transition --- Obsoleted" :anchor "" :extraInfo "unisos.icm elimination"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *ICM To CS Transition --- Obsoleted:* |]]  unisos.icm elimination  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
...
** Test with new
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Policies And Adopted Tools (Python 2.7 to 3.x Transition) -- Obsoleted" :anchor "" :extraInfo "Done in 2020"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Policies And Adopted Tools (Python 2.7 to 3.x Transition) -- Obsoleted:* |]]  Done in 2020  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
