...
** blee-Panels
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 0 :sep t :title "sysCharBoxMaterialize.sh" :anchor "" :extraInfo "On Manager & Target -- Assigned & New Box"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_     [[elisp:(org-cycle)][| _sysCharBoxMaterialize.sh_: |]]  On Manager & Target -- Assigned & New Box  [[elisp:(org-shifttab)][<)]] E|
####+END
...
####+END
####+BEGIN: blee:panel:icm:bash:cmnd :outLevel 1 :sep nil :folding? nil :label "Select" :icmName "echo sysCharDeploy.sh -h -v -n showRun -p targetName=curTargetBox -i boxFullActivate" :comment "" :afterComment ""
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /Select/ :: [[elisp:(lsip-local-run-command "echo sysCharDeploy.sh -h -v -n showRun -p targetName=curTargetBox -i boxFullActivate")][echo sysCharDeploy.sh -h -v -n showRun -p targetName=curTargetBox -i boxFullActivate]] *|*  == *|*    [[elisp:(org-shifttab)][<)]] E|
####+END:
