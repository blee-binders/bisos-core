...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-dev/howToBecomeDeveloper")][@ ~PROBLEM: Missing FV /bisos/panels/bisos-dev/howToBecomeDeveloper/destDesc~ @]]  [[elisp:(org-cycle)][| *=* |]] :: /Agenda/ <<PROBLEM: Missing FV /bisos/panels/bisos-dev/howToBecomeDeveloper/foldDesc>> [[elisp:(org-shifttab)][<)]] E|
####+END
