...
"
FILE="
*  /This File/ :: /bisos/panels/bisos-core/bootstrap/hardwareBox/BlankBox/hwGraphics/nvidia-geforce-rtx-5060-ti/rtx-5060-ti-driver-debian/_nodeBase_/bleePanelProc.sh 
"
if [ "${loadFiles}" == "" ] ; then
