...
"
FILE="
*  /This File/ :: /bisos/panels/bisos-core/bootstrap/hardwareBox/BlankBox/hwGraphics/nvidia-geforce-rtx-5060-ti/rtx-5060-ti-driver-nvidia/_nodeBase_/ftoProc.sh 
"
if [ "${loadFiles}" == "" ] ; then
