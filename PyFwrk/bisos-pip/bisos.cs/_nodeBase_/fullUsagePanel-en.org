...
** CsParams can be hierarchical -- Not implemeted yet. For example --if:lan:ipAddr=xx
** ------ ~FileParam~-s b.fp --------
...
** FpCsParam is a subClass of CsParam-s
** FpCsParam has a fileParam attribute as an instance of FileParam
** ------ ~FpCsBase~ b.fpIf.FpCsBase Abstract Class --------
...
** fps_manifest is a dict with key as FpCsParam-name and value as either "param" or "base"
