...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /nil/ :: [[elisp:(find-file "/bisos/pals/bin/palsAssign_lib.sh")][/bisos/pals/bin/palsAssign_lib.sh]] || [[elisp:(find-file-other-window "/bisos/pals/bin/palsAssign_lib.sh")][Visit In Other]] *|*  == *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /nil/ :: [[elisp:(find-file "/bisos/pals/bin/palsRealizationFPs_lib.sh")][/bisos/pals/bin/palsRealizationFPs_lib.sh]] || [[elisp:(find-file-other-window "/bisos/pals/bin/palsRealizationFPs_lib.sh")][Visit In Other]] *|*  == *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
