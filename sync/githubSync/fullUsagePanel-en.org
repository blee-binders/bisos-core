...
#+title: sync/githubSync
#+roam_tags: leaf
#+roam_key: bisos-core/sync/githubSync
...
**  This File :: *= /bisos/git/auth/bxRepos/blee-binders/bisos-core/sync/githubSync/fullUsagePanel-en.org =*
...
* [[elisp:(show-all)][(>]] ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
*   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseTop-50.png][http://www.freeprotocols.org]]_ _   ~Leaf:: bisos-core/sync -- githubSync~   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseBottom-50.png][http://www.by-star.net]]
...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-core/sync/githubSync")][githubSync]] *|*
...
####+END:
####+BEGIN: blee:panel:icm:bash:cmnd :outLevel 1 :sep nil :folding? nil :label "List" :icmName "bx-gitRepos -p vcMode=anon -i cachedLs" :comment "First time only" :afterComment ""
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /List/ :: [[elisp:(lsip-local-run-command "bx-gitRepos -p vcMode=anon -i cachedLs")][bx-gitRepos -p vcMode=anon -i cachedLs]] *|*  =First time only= *|*    [[elisp:(org-shifttab)][<)]] E|
####+END:
