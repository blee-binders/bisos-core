...
* [[elisp:(show-all)][(>]] ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
*   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseTop-50.png][http://www.freeprotocols.org]]_ _   bisos--~Node:: bisos-core/sync -- gitUsage~   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseBottom-50.png][http://www.by-star.net]]
...
####+BEGIN: blee:bxPanel:runResult :outLevel 3  :command "git --no-pager config --list --global"  :results "none" :comment "Allows you to edit" :afterComment "-- tailor the command line"
*** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     [[elisp:(lsip-local-run-command "git --no-pager config --list --global")][git --no-pager config --list --global]] *|*  =Allows you to edit= *|*  -- tailor the command line  [[elisp:(org-shifttab)][<)]] E|
####+END:
####+BEGIN: blee:bxPanel:runResult :outLevel 3  :command "echo git config --global user.email git@example.com"  :results "none" :comment "Allows you to edit" :afterComment "-- tailor the command line"
*** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     [[elisp:(lsip-local-run-command "echo git config --global user.email git@example.com")][echo git config --global user.email git@example.com]] *|*  =Allows you to edit= *|*  -- tailor the command line  [[elisp:(org-shifttab)][<)]] E|
####+END:
####+BEGIN: blee:bxPanel:runResult :outLevel 3  :command "echo git config --global user.name \\\\'First Last\\\\'"  :results "none" :comment "Allows you to edit" :afterComment "-- tailor the command line"
*** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     [[elisp:(lsip-local-run-command "echo git config --global user.name \\'First Last\\'")][echo git config --global user.name \\'First Last\\']] *|*  =Allows you to edit= *|*  -- tailor the command line  [[elisp:(org-shifttab)][<)]] E|
####+END:
####+BEGIN: blee:bxPanel:runResult :outLevel 3  :command "cd /bisos/git/bxRepos/bisos/blee ; git config --show-origin --get user.email"  :results "none" :comment "Allows you to edit" :afterComment "-- tailor the command line"
*** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     [[elisp:(lsip-local-run-command "cd /bisos/git/bxRepos/bisos/blee ; git config --show-origin --get user.email")][cd /bisos/git/bxRepos/bisos/blee ; git config --show-origin --get user.email]] *|*  =Allows you to edit= *|*  -- tailor the command line  [[elisp:(org-shifttab)][<)]] E|
####+END:
...
** If you just want to ignore what was stashed run: z k (Stash -> Drop).
...
** Then use SMerge and then commit
** Then get rid of your stash -- run: z k (Stash -> Drop).
** B|
...
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Workflow BCP (Best Current Practices):* |]]  Our Own Repo  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
...
***  [[elisp:(org-cycle)][| ]]  Cmnd                  ::  [[elisp:(lsip-local-run-command "git --no-pager config --global --list")][git --no-pager config --global --list]] [[elisp:(org-cycle)][| ]]
...
***  [[elisp:(org-cycle)][| ]]  Cmnd                  ::  [[elisp:(lsip-local-run-command "git --no-pager config --list")][git --no-pager config --list]]  # Per Repo And Global Info  [[elisp:(org-cycle)][| ]]
...
***
***  [[elisp:(org-cycle)][| ]]  Cmnd                  ::  [[elisp:(lsip-local-run-command "git --no-pager branch --all")][git --no-pager branch --all]]           # List All Existing Branches [[elisp:(org-cycle)][| ]]
***
...
***
***  [[elisp:(org-cycle)][| ]]  Cmnd                  ::  [[elisp:(lsip-local-run-command "git --no-pager branch")][git --no-pager branch]]           # List Selected Branches [[elisp:(org-cycle)][| ]]
***
...
####+END:
**  [[elisp:(org-cycle)][| ]]  Cmnd                  ::  [[elisp:(lsip-local-run-command "git --no-pager branch -a")][git --no-pager branch -a]]        # List all existing branches  [[elisp:(org-cycle)][| ]]
...
***
*** (With devBranch) git fetch origin master  # Or main
*** (With devBranch) git merge master  # Or main -- Resolve conflicts at this stage
***
