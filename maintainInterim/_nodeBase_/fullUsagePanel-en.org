...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/PALS/_nodeBase_")][ =PALS= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/PyFwrk/_nodeBase_")][ =PyFwrk= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/adoptedComponents/_nodeBase_")][ =adoptedComponents= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/baseDirs/_nodeBase_")][ =baseDirs= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/bisosAccts")][bisosAccts]] *|* 
...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/platform/_nodeBase_")][ =platform= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/ppMachine/_nodeBase_")][ =ppMachine= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/projs/_nodeBase_")][ =projs= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/registrations/_nodeBase_")][ =registrations= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos-core/sites/_nodeBase_")][ =sites= ]] *|* 
...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /BISOS Update/ :: [[elisp:(lsip-local-run-command "bisosUpdateInterim.sh -i examples")][bisosUpdateInterim.sh]]  [[elisp:(lsip-local-run-command "bisosUpdateInterim.sh -i visit")][visit]]  [[elisp:(lsip-local-run-command "bisosUpdateInterim.sh -i describe")][describe]] *|*  =Update container to interim changes= *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
####+END
** +
####+BEGIN: blee:panel:file:text/intro :outLevel 2 :sep t :folding nil :fileName "/bisos/git/bxRepos/bisos-pip/common/py3/bisos/common/baseDirBisos.py" :comment "Add New BaseDirs Here"  :afterComment ""
** /[[elisp:(beginning-of-buffer)][|^]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(delete-other-windows)][|1]]/
** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]  /nil/ :: [[elisp:(find-file "/bisos/git/bxRepos/bisos-pip/common/py3/bisos/common/baseDirBisos.py")][baseDirBisos.py]] || [[elisp:(find-file-other-window "/bisos/git/bxRepos/bisos-pip/common/py3/bisos/common/baseDirBisos.py")][Visit In Other]] *|*  =Add New BaseDirs Here= *|*   [[elisp:(org-shifttab)][<)]] E|
####+END:
...
####+END
** +
** bisosUpdateInterim.sh -h -v -n showRun -i aptUpgrades    # apt-get -y upgrade
...
** bisosUpdateInterim.sh -h -v -n showRun -i bisosBasesPull  # with bx-gitRepos
 B|
