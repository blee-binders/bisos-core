...
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_     [[elisp:(outline-show-subtree+toggle)][| MCP vs RAG vs Skills: |]]      :: [[elisp:(find-file "./m")][Pdf Here]] || [[elisp:(find-file-other-window "./m")][Pdf Other]] || [[elisp:(lsip-local-run-command "acroread -openInNewInstance /bisos/panels/bisos-core/AI/AiGeneralInfo/m &")][Pdf Acroread]] ||  [[elisp:(org-shifttab)][<)]] E|
####+END:
