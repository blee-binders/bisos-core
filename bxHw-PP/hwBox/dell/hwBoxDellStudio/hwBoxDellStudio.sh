...
typeset RcsId="$Id: hwBoxDellStudio.sh,v 1.1 2020-05-10 01:46:03 lsipusr Exp $"
# *CopyLeft*
...
**  [[elisp:(org-cycle)][| ]]        ::  Dual Chanel DDR4 2133 about \$130 (201604) for 2x8=16 gig sticks   [[elisp:(org-cycle)][| ]]
*** nvidia-375
    7) "sudo apt install nvidia-375" # helped me to resolve the text breaks on the screen.
_EOF_
}
