...
**  This File :: *= /libre/ByStar/InitialTemplates/activeDocs/bxHw-PP/Graphics/hwGraphicsNvidia/fullUsagePanel-en.org =* 
...
####+END
####+BEGIN: blee:bxPanel:title :panelType "=bxPanel=" :title "~Nvidia Graphics Cards~"
* [[elisp:(show-all)][(>]] -------------------------------------------------------------------------------------------------- 
*   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseTop-50.png][http://www.freeprotocols.org]]_ _   ~Nvidia Graphics Cards~   [[img-link:file:/bisos/blee/env/images/fpfByStarElipseBottom-50.png][http://www.by-star.net]]
...
** Overview Comes Here.
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Nvidia Geforce gt 740m" :anchor "" :extraInfo ""
* /[[elisp:(beginning-of-buffer)][|^]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(delete-other-windows)][|1]]/ 
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]       [[elisp:(org-cycle)][| *Nvidia Geforce gt 740m:* |]]    [[elisp:(org-shifttab)][<)]] E|
####+END
